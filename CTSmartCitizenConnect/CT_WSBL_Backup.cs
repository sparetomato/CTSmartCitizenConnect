            ...
            try
            {
                ...
                if (reissuePass)
                {
                    ...
                    buildJobData(ref existingPassHolder, CPICC, null, passHolderNumber, firstNameOrInitial, surname, houseOrFlatNumberOrName,
                        ...
                        disabilityPermanent, evidenceExpiryDate, null, UPRN, homePhone, mobilePhone, emailAddress);
                ...
                else
                {
                    ...
                    {
                        if (log.IsDebugEnabled) log.Debug("Could not set Achieve Service Case Number to:[" + achieveServiceCaseNumber + "]. Setting to -1");
                        existingPassHolder.CtPass.NorthgateCaseNumber = "-1";
                    }
